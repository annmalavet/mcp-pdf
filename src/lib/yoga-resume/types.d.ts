...
export declare function isTwoColumnConfig(config: LayoutConfig): config is TwoColumnConfig;
/**
 ...
 */
export declare const ENTRY_COLUMN_GAP = 10;
/**
 ...
 */
export declare function calculateEntryColumnWidths(totalWidth: number, dateColumnWidth: number): EntryColumnWidths;
