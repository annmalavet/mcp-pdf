 ...
 */
export type RenderType = 'header' | 'entry-list' | 'keyword-list' | 'language-list' | 'credential-list' | 'reference-list' | 'summary-highlights' | 'text';
...
export declare function isDividerConfig(config: SectionConfig | DividerConfig): config is DividerConfig;
export declare function isSectionConfig(config: SectionConfig | DividerConfig): config is SectionConfig;
export {};
